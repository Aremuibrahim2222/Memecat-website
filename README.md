...
Landing page for Memecat, a Solana memecoin. Built with Next.js 14 (App Router) and Tailwind CSS.

## Design

Cinema-marquee theme: a movie-poster red (`#E1261C`), warm ink black, popcorn gold, and a touch of Solana violet/teal for chain branding. Headlines use **Anton** (marquee/poster lettering), body text uses **Space Grotesk**. Recurring motifs: marquee bulb strips, a scrolling LED ticker, ticket-stub cards, and a film-strip divider.
